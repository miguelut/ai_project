...
constant or dynamic in nature.  Generally, a queue data structure is used to
keep track of which node to expand next because a queue has the FIFO property.
This makes it ideal for searching in a specific order.\cite{norvig}\newline
\indent 
