...
#
# This file contains the definition of the model for a 3X3X3 cube along with all
# of the functions needed to create it, manipulate it and visualize it.  Import
# this file to impliment a solving algorithm.
#
